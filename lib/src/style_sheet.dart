...
class MarkdownStyleSheet {
  ...
  MarkdownStyleSheet copyWith({
    ...
    return MarkdownStyleSheet(
      ...
      tableVerticalAlignment:
          ...
          tableScrollAble: tableScrollAble ?? this.tableScrollAble,
  ...
  MarkdownStyleSheet merge(MarkdownStyleSheet? other) {
    ...
    return copyWith(
      ...
      tableScrollAble: other.tableScrollAble,
  ...
  /// The tableScrollAble to use for table enable scroll.
  ...
  bool operator ==(Object other) {
    ...
    return other is MarkdownStyleSheet &&
        ...
        other.tableScrollAble == tableScrollAble &&
